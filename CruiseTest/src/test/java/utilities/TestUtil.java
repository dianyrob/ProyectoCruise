...
public class TestUtil extends TestBase {
	...
	public static void clickAtElement(String locator) {
		WebListeners listener= new WebListeners();
		EventFiringMouse mouse = new EventFiringMouse(driver, listener);
		Locatable hoverItem = (Locatable) driver.findElement(By.cssSelector(OR.getProperty(locator)));
